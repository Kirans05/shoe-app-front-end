...
const UBody = () => {
    ...
    const {tocken, cartItem, setcartItem, setselectedProduct} = useContext(MainContext)
  ...
  return (
    <Box>
      <Box>
        ...
        <Button colorScheme="teal" size="md" onClick={()=> nav("/cart")}>
          Cart
        </Button>
        <Button colorScheme="teal" size="md" onClick={() => nav("/myOrdres")}>
          Orders
        </Button>
      </Box>
      <Box 
